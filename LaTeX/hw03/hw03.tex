...
\author{班級：\underline{資工一}、學號：\underline{111590007}、姓名：\underline{徐羿}}
\orcid{}
\affiliation{%
  \institution{}
  \city{}
...
\begin{shaded}
    ...
    \end{lstlisting}
\end{shaded}
The statement $t := t + i + j$ is executed \answer{3.3.2a}{} times, so the number of operations is $O(\answer{3.3.2b}{})$.
