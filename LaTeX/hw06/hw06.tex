...
\end{shaded}  
There are \answer{6.1.36}{$2^n$} such functions, since there is a choice of 2 function values for each element of the domain.
...
& = & \answer{6.4.10a}{81}x^4 + \answer{6.4.10b}{-108}x^3y^2 + \answer{6.4.10c}{54}x^2y^4 +\\ \answer{6.4.10d}{-12}x y^6 + y^8
\end{eqnarray*}
...
\end{shaded}
\begin{eqnarray*}
C(\answer{6.5.14a}{4} + \answer{6.5.14b}{17} - 1, \answer{6.5.14c}{17}) = C(20, \answer{6.5.14d}{17}) = \answer{6.5.14e}{1140}
\end{eqnarray*}
...
\begin{enumerate}[label=(\alph*)]
	...
	\item C(\answer{6.5.16.1a}{6} + \answer{6.5.16.1b}{7}-1, \answer{6.5.16.1c}{7}) = C(\answer{6.5.16.1d}{12}, \answer{6.5.16.1e}{7}) = \answer{6.5.16.1f}{7922}
	\item \answer{6.5.16.2}{179976}
    \item \answer{6.5.16.3}{46942} 
\end{enumerate}
...
\end{shaded}
\begin{eqnarray*}
C(\answer{6.5.20a}{4} + \answer{6.5.20b}{11} - 1, \answer{6.5.20c}{11}) = C(14, \answer{6.5.20d}{11}) = \answer{6.5.20e}{364}
\end{eqnarray*}
...
\begin{eqnarray*}
C(\answer{6.5.68a}{3} + \answer{6.5.68b}{100} - 1, \answer{6.5.68c}{100}) = C(102, \answer{6.5.68d}{100}) = \answer{6.5.68e}{5151}
\end{eqnarray*}
